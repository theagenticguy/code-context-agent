...
- add write_file tool so agent can persist CONTEXT.md (#4)
...
- add MkDocs Material documentation site and CI/CD pipeline

### Fix

- update uv.lock to match v6.1.0 version bump
- **security**: check raw token path in sensitive directory validation
...
- **ci**: consolidate deps-update script into single block for CI YAML validation
